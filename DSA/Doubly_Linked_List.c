...
void insert_end()
{
EMPLOYEE node, temp; node = create();
if ( start == NULL ) 
{
start = node;
}
...
{
printf ( "\nThe deleted employee ssn is %s", temp->ssn ); free ( temp );
start = NULL;
}
else
{
...
case 7: double_ended_queue(); break;
case 8: return ( 0 );
default: printf ( "\nInvalid Choice!!!" );
}
}
